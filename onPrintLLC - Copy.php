...
logMessage("knut150.txt", "9");
setupSchema('JurBot');

logMessage("knut150.txt", "0");
...
////////////////////////////////////////////////////
    ...
    for ($i = 1; $i <= $num; $i++) {
        ...
        $detail = "$Q_25 $Q_26 $Q_27 - вклад в денежной форме в размере $Q_47A  ( $str47A ), в не денежной форме $Q_47B ( $str47B );";
...
$values["Q_90_Number"] =$phoneBreakdown02[1];
    ...
    $templates = ["files/RegLLC00/application00.docx",
...
function onPrint10($values, $fileuuid) {
    ...
    $templates = ["files/RegLLC10/application.docx",
...
function onPrint($values, $fileuuid) {
    ...
    if ($totalFounders > 1) {
        ...
        sendFilesToAlfaBank_1($values, $fileuuid);        
    }
}

logMessage("knut150.txt", "1");

onPrint($values, $fileuuid);

logMessage("knut150.txt", "2");
